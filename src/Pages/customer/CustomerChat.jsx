...
function CustomerChat() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F5F7EB] to-[#E8F0D8] flex flex-col">
      ...
      {/* Header */}
      <div className="bg-[#97A36D] shadow-xl">
      ...
      <div className="flex-1 max-w-7xl mx-auto w-full px-6 py-8">
        <div className="space-y-8">
          ...
          {/* Support Options Banner - FIXED STRUCTURE */}
          <div className="bg-gradient-to-r from-[#97A36D] to-[#7e8a5a] rounded-3xl shadow-2xl p-8 text-center text-white transform hover:shadow-2xl transition-all duration-300">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button 
                  ...
                  className="bg-white text-[#97A36D] px-8 py-4 rounded-xl hover:bg-lime-50 transition-all duration-300 font-semibold flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                  </svg>
